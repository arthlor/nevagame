...
describe("TerrainSurfaceMaterial", () => {
  ...
  it("patches the installed Three.js standard shader and exposes a stable cache key", () => {
    ...
    expect(shader.fragmentShader).toContain("terrainBeachColorTexture");
    expect(shader.fragmentShader).toContain("terrainBeachSignal");
    expect(shader.fragmentShader).toContain("vegetationMask");
    expect(shader.fragmentShader).toContain("shoreMask");
    expect(shader.fragmentShader).toContain("terrainShorePolygonTint");
    expect(shader.fragmentShader).toContain("terrainBeachExternalColor");
    expect(shader.fragmentShader).toContain("terrainShoreExternalColor");
    expect(shader.fragmentShader).toContain("terrainBeachExternalColorStrength");
    ...
    expect(shader.uniforms.terrainBeachLodBias.value).toBe(0.2);
    expect(shader.uniforms.terrainBeachFineMix.value).toBe(0.38);
