...
This directory supports the authored generators in `tools/authored/generators/` and the ports of frozen families. Generation still goes through the catalog CLI (`npm run art:generate -- --asset <id>`), not a one-off GLB.
