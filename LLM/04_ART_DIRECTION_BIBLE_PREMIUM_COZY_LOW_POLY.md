...
Grass: coordinated terrain color, connected instanced short cover and taller wind-catching meadow groups. Short grass uses many slender curved blades with distributed roots; overlapping patches make a continuous meadow instead of sparse broad wedges. Taller grasses keep finer proportions and remain local accents. Use yellow-green highlights + olive/sage shadows, with patch-level palette grouping and semantic suppression around roads, buildings, working farm areas and exposed rock. Reeds retain wet-edge ownership.
