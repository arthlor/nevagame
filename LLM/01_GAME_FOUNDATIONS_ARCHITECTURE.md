...
Representative state (`CURRENT_SCHEMA_VERSION = 45`, `world.layoutRevision = 20`):
```ts
interface GameState {
...
- on-foot: contextual third-person framing, damping and moderate zoom; open exploration lowers pitch and widens the lens while working areas and nearby interactions retain task framing;
