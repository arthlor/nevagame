...
def action_checklist(spec,motions,diagnostic,contacts):
    ...
    for clip in [*spec['animationClips'],*spec.get('additionalAnimationClips',[])]:
        ...
        if name in ('skiff_idle','skiff_drive','skiff_fishing','board_skiff','dock_skiff'):equipment+=['skiff standing deck','both helm grips' if name=='skiff_drive' else 'helm released']
