...
- Current persistence is schema **v25**, layout revision 9. `01` §6.1 owns the per-version ledger; the layout-9 causal river migration is v24 and the later calendar retune is v25. Historical versions and their preservation boundaries remain in that single ledger rather than being repeated here.
...
### Starter island mountains and finite spring
