...
/** Layout 14 only changes dressing. Preserve clear poses and every gameplay transaction. */
export function migrateTerrainLayout14(previous: GameState): GameState {
  ...
  const state: GameState = { ...previous, schemaVersion: 34, player: { ...previous.player },
    boats: { ...previous.boats }, mounts: { ...previous.mounts }, world: { ...previous.world, layoutRevision: 14 } };
