...
- **Catalog art / GLB production:** obey `LLM/ASSET_PRODUCTION.md`, then use
...
There is no Blender or Python asset builder; `npm run art:generate` with an
explicit selector is the only generate-asset front door.
